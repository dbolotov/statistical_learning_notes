...
Ridge regression and lasso do not use least squares to fit. Rather, they use a coefficient that has a penalty that shrinks the coefficients towards zero. These methods can be applied to datasets with many variables (1000's to 1000000's).
